...
// while loop helps us avoid repitation
var i = 1;
while(i <= 5){
...
for(var b = 10;b <= 10 && b >= 1; b--){
    console.log(b )
}
//
const number = prompt('please enter the end value')
    for(var w = number; w <= number  &&  w >= 1  ; w--){
    if(w % 2 === 0){
        document.write(`<h2 class="even" >${w}</h2>`)
    }
}